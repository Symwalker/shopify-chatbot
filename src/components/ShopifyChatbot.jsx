...
//     const selectedText = selectedProducts.map(p => `${p.id}. ${p.name}`).join(', ');
...
//     if (file) {
//       setCurrentProductData(prev => ({ ...prev, file, fileName: file.name }));
        ...
        <div className="h-full flex flex-col bg-gradient-to-br from-green-400 to-green-600">
          ...
          <div className="bg-white rounded-t-3xl p-6 shadow-2xl">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white py-3 px-6 rounded-full font-medium hover:from-purple-700 hover:to-blue-700 transition-all shadow-lg flex items-center justify-center gap-2"
            >
